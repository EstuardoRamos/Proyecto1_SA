...
public class Reserva {
  public enum Estado { RESERVADA, CHECKED_IN, CHECKED_OUT, CANCELADA }
  ...
  public void setRango(LocalDate in, LocalDate out) {
    ...
    this.entrada = in; this.salida = out;
  }
  public void setHuespedes(int n) {
    if (n < 1) throw new IllegalArgumentException("Huéspedes debe ser >= 1");
    this.huespedes = n;
  }
  public long noches() { return ChronoUnit.DAYS.between(entrada, salida); }
  public void setTotal(BigDecimal t) { this.total = t; }
  public void checkIn() { if (estado != Estado.RESERVADA) throw new IllegalStateException("No se puede hacer check-in"); estado = Estado.CHECKED_IN; }
  public void checkOut() { if (estado != Estado.CHECKED_IN) throw new IllegalStateException("No se puede hacer check-out"); estado = Estado.CHECKED_OUT; }
  public void cancelar() { if (estado == Estado.CHECKED_OUT) throw new IllegalStateException("No se puede cancelar"); estado = Estado.CANCELADA; }

  public UUID getId(){return id;} public UUID getHotelId(){return hotelId;}
  public UUID getHabitacionId(){return habitacionId;} public UUID getClienteId(){return clienteId;}
  public LocalDate getEntrada(){return entrada;} public LocalDate getSalida(){return salida;}
  public int getHuespedes(){return huespedes;} public Estado getEstado(){return estado;}
